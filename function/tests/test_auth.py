...
from function_app import api_auth, make_token, verify_token
...
class TestApiAuth:
    ...
    def test_correct_password_returns_200_with_token_and_maps_key(self):
        req = _post_request({"password": "honeymoon"})
        resp = api_auth(req)
    ...
    def test_wrong_password_returns_401(self):
        req = _post_request({"password": "wrongpassword"})
        resp = api_auth(req)
